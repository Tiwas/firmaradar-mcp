...
HANDLER = ToolHandler(
    ...
    description=(
        ...
        "shareholder register) and reflects the latest filed holdings. The "
        "result contains ownership edges, percentages and company identifiers "
        "for the requested traversal direction."
    ),
