...
HANDLER = ToolHandler(
    ...
    description=(
        ...
        "or `disclaimer_required`, inform the user that confirmation is "
        "required. Call `firmaradar_confirm_risk_score_disclaimer` only after "
        "the user has explicitly instructed you to confirm the disclaimer. "
        "The confirmation is per OAuth user, not per call, and is permanent "
        "and audit-logged. Alternatively the user can confirm manually at "
